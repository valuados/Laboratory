    ...
    $.fn.editableutils = {
        ...
        */
        setCursorPosition: function(elem, pos) {
            if($(elem).attr('type') == 'number') return
        ...
        value2htmlFinal: function(value, element) {
           ...
           if(checked.length) {
               ...
               $.each(checked, function(i, v) {
                   ...
                   html.push(text);
                   $(element).append($('<span>').addClass("item").text(text));
               });
           } else {
               $(element).empty();
           }
...
(function ($) {
    ...
    $.extend(NumberInput.prototype, {
        ...
        value2html: function(value, element) {
            ...
            if($.isNumeric(value)) {
                value = parseFloat(value).formatNormal();
            } else {
                value = 0;
            }
            $(element)[this.options.escape ? 'text' : 'html'](value);
        },
        postrender: function() {
            if(this.$clear) {
...
Number.prototype.formatNormal = function() {
