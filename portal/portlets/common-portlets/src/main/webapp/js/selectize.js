...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		...
		addItem: function(value, silent) {
			...
			debounce_events(this, events, function() {
				...
				if (self.isSetup) {
                    ...
                    if (!value.length || (typeof self.settings.onAddItem === 'function' && self.settings.onAddItem.apply(self, [value, $item, self.$dropdown]) === false)) {
                        return false;
                    }
				}
			});
		...
		open: function() {
            ...
            setTimeout(function() {
                if (!self.$dropdown || (typeof self.settings.onDropDownOpen === 'function' && self.settings.onDropDownOpen.apply(self, self.$dropdown) === false)) {
                    return false;
                }
            },50);
		...
		deleteSelection: function(e) {
            ...
            if (!values.length || (typeof self.settings.onDelete === 'function' && self.settings.onDelete.apply(self, [values, self.$dropdown]) === false)) {
                return false;
            }
