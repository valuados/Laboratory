...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="fm" style="margin-top:10px;">
			...
			<aui:fieldset  style="margin-top:10px;">
			...
			<aui:button-row>
				<aui:button type="submit" class="button button_blue" value="sign-in" />
			</aui:button-row>
		</aui:form>
