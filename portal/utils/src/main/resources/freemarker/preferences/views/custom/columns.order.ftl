...
<#-- @ftlvariable name="value" type="com.netcracker.laboratory.portlets.utils.preferences.renderers.custom.ColumnsOrderingRenderer.ColumnsOrdering" -->
...
<div class="controls columns-ordering">
...
<script>
    (function ($) {
        $(function () {
            var container = $('.controls.columns-ordering');
...
<style>
    .columns-ordering .etalon {
        display: none;
    }

    .columns-ordering .button-holder {
        margin-bottom: 12px;
    }
